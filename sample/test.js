...
var AuthenticateTestController =
  require('../lib/apicontrollers.js').AuthenticateTestController
...
ctrl.execute(function () {
  ...
  console.log(
    'Result Code: ' + JSON.stringify(response.getMessages().getResultCode())
  )
  console.log(
    'Message List: ' + JSON.stringify(response.getMessages().getMessage())
  )
  console.log(
    'Code: ' + JSON.stringify(response.getMessages().getMessage()[0].getCode())
  )
  console.log(
    'Text: ' + JSON.stringify(response.getMessages().getMessage()[0].getText())
  )
})
